...
export function middleware(request: NextRequest) {
  ...
  const blocId = request.cookies.get('blocId')
    ...
    if((request.nextUrl.pathname.startsWith('/create') || request.nextUrl.pathname.startsWith('/dashboard') || request.nextUrl.pathname.startsWith('/bloc') || request.nextUrl.pathname.startsWith('/onboarding')) && !request.cookies.get('user')){
