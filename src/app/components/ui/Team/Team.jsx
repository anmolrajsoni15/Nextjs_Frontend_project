    ...
    <section className="py-10">
      <div className="max-w-[90%] mx-auto md:px-8">
        <div className="flex flex-col w-full items-center justify-center">
            ...
            <p className="text-white mt-3 text-center max-w-2xl text-base font-roboto">
            Welcome to our team of ambitious and innovative engineers, dedicated
            to constructing Bloc for the exciting and groundbreaking AI-First Era.{" "}
            </p>
        </div>
          ...
          <ul className="grid gap-8 gap-x-32 sm:grid-cols-2 lg:grid-cols-3 mx-auto">
            {team.map((item, idx) => (
              <li key={idx} className="flex gap-4 items-center">
                ...
                <div>
                  <h4 className="text-gray-300 font-semibold sm:text-lg">
                    {item.name}
                  </h4>
