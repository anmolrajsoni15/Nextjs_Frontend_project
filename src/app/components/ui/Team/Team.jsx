...
import daksh from "../../../../../public/images/daksh.png";
import shrish from "../../../../../public/images/shrish.png";
import harsh from "../../../../../public/images/todi.png";
import nitya from "../../../../../public/images/nitya.png";
import shivam from "../../../../../public/images/shivam.png";
import rachita from "../../../../../public/images/rachita.png";
    ...
    return (
        <section className="py-10">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                    <h3 className="text-center text-gray-200 text-3xl font-semibold sm:text-4xl ">
                        Meet our team
                    </h3>
                    <p className="text-gray-400 mt-3 text-center">
                    Welcome to our team of ambitious and innovative engineers, dedicated to constructing Bloc for the exciting and groundbreaking AI-First Era.                    </p>
                <div className="mt-12">
                    <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                        {
                            team.map((item, idx) => (
                                <li key={idx} className="flex gap-4 items-center">
                                    ...
                                    <div>
                                        <h4 className="text-gray-300 font-semibold sm:text-lg">{item.name}</h4>
                                        <p className="text-[#28A1FF]">{item.title}</p>
