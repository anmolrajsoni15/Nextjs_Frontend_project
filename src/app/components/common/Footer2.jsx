...
const Footer2 = () => {
    ...
    return (
        <footer className="pt-10 bg-[#121212] text-[#7d7d7d] px-5 w-11/12 mx-auto">
            <div className="flex flex-col py-16 border-t border-solid border-[#464646] mt-24 gap-8">
        <div className="flex items-center justify-center gap-4">
            <Image src="/images/logo.png" alt="bloc" width={48} height={48} />
            <div className="text-white font-poppins text-2xl font-semibold">Bloc</div>
        </div>
        <div className="flex items-center justify-center gap-8 text-[#D1D5DB] font-inter text-base font-semibold">
            <div>Resources</div>
            <div>Usecases</div>
            <div>Pricing</div>
        </div>
            ...
            <div className="w-full">
                <div className="pb-8 items-center justify-between sm:flex">
                    ...
                    <div className="flex items-center justify-center gap-x-6 text-gray-500 mt-6 sm:mt-0">
                        ...
                        <Link href="https://twitter.com/mysticlabsai" target="_blank" aria-label="Twitter" alt="Twitter">
                        ...
                        <Link href="https://www.linkedin.com/company/mystic-labs-ai/" target="_blank" aria-label="Linkedin" alt="Linkedin">
