...
const Sidebar: React.FC<Props> = ({ allBlocs }) => {
  ...
  return (
    <section
      className={` w-[225px] flex-shrink-0 object-contain flex flex-col justify-between  border-r-2 py-6  top-0 sticky h-screen`}
    >
      <div className="px-6">
        ...
        >
          {allBlocs === undefined || allBlocs < 3 ? (
            ...
            >
              <h1 className="text-center font-spacegrotesk font-bold text-5xl">
                New Bloc
              </h1>
              <div className="w-full">
                <label
                  htmlFor=""
                  className="text-lg font-spacegrotesk font-medium text-[#e7e7e7] pl-1"
                >
                  Name
                </label>
                <input
            ...
            <div className="flex flex-col w-[50vw] p-8 py-10 gap-6 items-center justify-center bg-[#181818] text-white rounded-lg">
              ...
              <div className="flex items-center justify-center gap-7 w-full">
                <button onClick={closeModal} className="bg-[#292929] text-sm font-spacegrotesk font-medium rounded px-9 py-3">Go Back</button>
      ...
      <div className="space-y-16">
        ...
        <div className="px-6 space-y-4">
          ...
          <Link
            href={"mailto:shrish@mysticlabs.ai"}
