...
function Chatbot() {
    ...
    return (
        <div className='h-[450px]  rounded-lg border-[1px] border-borderColor bg-[#272727] flex-col'>
            <div className='h-[52px] border-b-[1px] flex items-center justify-between '>
                <div className='flex items-center space-x-2 ml-4 '>
                    <div className="relative md:h-10 md:w-10 h-4 w-4">
                        <Image
                    ...
                    <div>
                        <div className='text-2xl font-poppins font-semibold '>Bloc</div>
                        <p className='text-base font-spacegrotesk font-medium leading-5'>Share product upadates</p>
                    </div>
                </div>
